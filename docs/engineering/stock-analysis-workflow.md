...
负责。三期已证明重要信息可以由现有 W0–W10 接纳，因此不新增 W11 或新工作流。
...
仍只有巨潮公告索引、新浪结构化三表和腾讯行情快照三个封闭来源；结构化适配只覆盖四个数据域。
SEMI、OFAC、SEC EDGAR、药明康德 IR 等按用途由 Agent 或人工使用，ClinicalTrials.gov 当前只
适合 W4 的逐条人工研究；其余来源继续保留候选、待授权、未实现或不采用状态。
